...
public enum DUNGEON_STAIR_DIRECTION {
    UNKNOWN = 0,
    UP = 1,
    DOWN = 2
}

public enum DUNGEON_LAYOUT {
    UNKNOWN = 0,
    SQUARE = 1,
    BOX = 2,
    KEEP = 3,
...
public enum DUNGEON_CORRIDOR_LAYOUT {
    UNKNOWN = 0,
    LABYRINTH = 1,
    BENT = 2,
    STRAIGHT = 3
...
public enum DUNGEON_ROOM_LAYOUT {
    UNKNOWN = 0,
    PACKED = 1,
    SCATTERED = 2
};

public enum DUNGEON_END_TYPE {
    WALLED = 0,
    CORRIDOR = 1,
    STAIR = 2,
    NEXT = 3,
...
public class RoomData {
    ...
    public Dictionary<DUNGEON_DIRECTION, DoorData> door;
    ...
    public RoomData(int id, int row, int column, int north, int south, int west, int east, int width, int height) {
        ...
        this.door = new Dictionary<DUNGEON_DIRECTION, DoorData>();
...
public class SillData {
    ...
    public SillData(int sillR, int sillC, DUNGEON_DIRECTION dir, int doorR, int doorC) {
        this.sillR = sillR;
        this.sillC = sillC;
        this.dir = dir;
        this.doorR = doorR;
...
public class DoorData {
    ...
    public int row;
    public int col;
    public DUNGEON_DOOR_TYPE type;
    public string description;

    public int outID;
    public bool outIDWasSet;

    public DoorData(int row, int col, DUNGEON_DOOR_TYPE type, string description) {
        this.row = row;
        this.col = col;
        this.type = type;
...
public class StairData {
    ...
    public int row;
    public int col;
    public DUNGEON_STAIR_DIRECTION dir;
    public int nextRow;
    public int nextCol;
...
public class Dungeon {
    ...
    protected static Dictionary<DUNGEON_LAYOUT, int[][]> dungeonLayouts = new Dictionary<DUNGEON_LAYOUT, int[][]>() {
        { DUNGEON_LAYOUT.UNKNOWN,               new int[][] { new int[] { 1, 1, 1 }, new int[] { 1, 1, 1 }, new int[] { 1, 1, 1 } }},
        { DUNGEON_LAYOUT.SQUARE,                new int[][] { new int[] { 1, 1, 1 }, new int[] { 1, 1, 1 }, new int[] { 1, 1, 1 } }},
        { DUNGEON_LAYOUT.BOX,                   new int[][] { new int[] { 1, 1, 1 }, new int[] { 1, 0, 1 }, new int[] { 1, 1, 1 } }},
        { DUNGEON_LAYOUT.KEEP,                  new int[][] { new int[] { 1, 0, 1 }, new int[] { 0, 1, 0 }, new int[] { 1, 0, 1 } }},
        { DUNGEON_LAYOUT.CROSS,                 new int[][] { new int[] { 0, 1, 0 }, new int[] { 1, 1, 1 }, new int[] { 0, 1, 0 } }},
        { DUNGEON_LAYOUT.DAGGER_UP,             new int[][] { new int[] { 0, 1, 0, 0 }, new int[] { 1, 1, 1, 1 }, new int[] { 0, 1, 0, 0 } }},
        { DUNGEON_LAYOUT.DAGGER_DOWN,           new int[][] { new int[] { 0, 0, 1, 0 }, new int[] { 1, 1, 1, 1 }, new int[] { 0, 0, 1, 0 } }},
        { DUNGEON_LAYOUT.DAGGER_LEFT,           new int[][] { new int[] { 0, 1, 0 }, new int[] { 1, 1, 1 }, new int[] { 0, 1, 0 }, new int[] { 0, 1, 0 } }},
        { DUNGEON_LAYOUT.DAGGER_RIGHT,          new int[][] { new int[] { 0, 1, 0 }, new int[] { 0, 1, 0 }, new int[] { 1, 1, 1 }, new int[] { 0, 1, 0 } }}
    };

    protected static Dictionary<DUNGEON_CORRIDOR_LAYOUT, int> corridorLayouts = new Dictionary<DUNGEON_CORRIDOR_LAYOUT, int>() {
        { DUNGEON_CORRIDOR_LAYOUT.UNKNOWN,      100 },
        { DUNGEON_CORRIDOR_LAYOUT.LABYRINTH,    0 },
        { DUNGEON_CORRIDOR_LAYOUT.BENT,         50 },
        { DUNGEON_CORRIDOR_LAYOUT.STRAIGHT,     100 }
    };

    protected static Dictionary<DUNGEON_DIRECTION, int> di = new Dictionary<DUNGEON_DIRECTION, int>() {
        { DUNGEON_DIRECTION.NORTH,  -1 },
        { DUNGEON_DIRECTION.SOUTH,  1 },
        { DUNGEON_DIRECTION.EAST,   0 },
        { DUNGEON_DIRECTION.WEST,   0 }
    };
    protected static Dictionary<DUNGEON_DIRECTION, int> dj = new Dictionary<DUNGEON_DIRECTION, int>() {
        { DUNGEON_DIRECTION.NORTH,  0 },
        { DUNGEON_DIRECTION.SOUTH,  0 },
        { DUNGEON_DIRECTION.EAST,   1 },
        { DUNGEON_DIRECTION.WEST,   -1 }
    };

    protected static Dictionary<DUNGEON_DIRECTION, DUNGEON_DIRECTION> opposite = new Dictionary<DUNGEON_DIRECTION, DUNGEON_DIRECTION>() {
        { DUNGEON_DIRECTION.NORTH, DUNGEON_DIRECTION.SOUTH },
        { DUNGEON_DIRECTION.SOUTH, DUNGEON_DIRECTION.NORTH },
        { DUNGEON_DIRECTION.WEST, DUNGEON_DIRECTION.EAST },
        { DUNGEON_DIRECTION.EAST, DUNGEON_DIRECTION.WEST }
    };

    protected static Dictionary<DUNGEON_DIRECTION, Dictionary<DUNGEON_END_TYPE, int[][]>> stairEnd = new Dictionary<DUNGEON_DIRECTION, Dictionary<DUNGEON_END_TYPE, int[][]>>() {
        { DUNGEON_DIRECTION.NORTH, new Dictionary<DUNGEON_END_TYPE, int[][]>() {
            { DUNGEON_END_TYPE.WALLED,     new int[][] { new int[] {1, -1}, new int[] {0, -1}, new int[] {-1, -1}, new int[] {-1, 0}, new int[] {-1, 1}, new int[] {0, 1}, new int[] {1, 1} }},
            { DUNGEON_END_TYPE.CORRIDOR,   new int[][] { new int[] {0, 0}, new int[] {1, 0}, new int[] {2, 0} }},
            { DUNGEON_END_TYPE.STAIR,      new int[][] { new int[] {0, 0} }},
            { DUNGEON_END_TYPE.NEXT,       new int[][] { new int[] {1, 0} }}
        }},
        { DUNGEON_DIRECTION.SOUTH, new Dictionary<DUNGEON_END_TYPE, int[][]>() {
            { DUNGEON_END_TYPE.WALLED,     new int[][] { new int[] {-1, -1}, new int[] {0, -1}, new int[] {1, -1}, new int[] {1, 0}, new int[] {1, 1}, new int[] {0, 1}, new int[] {-1, 1} }},
            { DUNGEON_END_TYPE.CORRIDOR,   new int[][] { new int[] {0, 0}, new int[] {-1, 0}, new int[] {-2, 0} }},
            { DUNGEON_END_TYPE.STAIR,      new int[][] { new int[] {0, 0} }},
            { DUNGEON_END_TYPE.NEXT,       new int[][] { new int[] {-1, 0} }}
        }},
        { DUNGEON_DIRECTION.WEST, new Dictionary<DUNGEON_END_TYPE, int[][]>() {
            { DUNGEON_END_TYPE.WALLED,     new int[][] { new int[] {-1, 1}, new int[] {-1, 0}, new int[] {-1, -1}, new int[] {0, -1}, new int[] {1, -1}, new int[] {1, 0}, new int[] {1, 1} }},
            { DUNGEON_END_TYPE.CORRIDOR,   new int[][] { new int[] {0, 0}, new int[] {0, 1}, new int[] {0, 2} }},
            { DUNGEON_END_TYPE.STAIR,      new int[][] { new int[] {0, 0} }},
            { DUNGEON_END_TYPE.NEXT,       new int[][] { new int[] {0, 1} }}
        }},
        { DUNGEON_DIRECTION.EAST, new Dictionary<DUNGEON_END_TYPE, int[][]>() {
            { DUNGEON_END_TYPE.WALLED,     new int[][] { new int[] {-1, -1}, new int[] {-1, 0}, new int[] {-1, 1}, new int[] {0, 1}, new int[] {1, 1}, new int[] {1, 0}, new int[] {1, -1} }},
            { DUNGEON_END_TYPE.CORRIDOR,   new int[][] { new int[] {0, 0}, new int[] {0, -1}, new int[] {0, -2} }},
            { DUNGEON_END_TYPE.STAIR,      new int[][] { new int[] {0, 0} }},
            { DUNGEON_END_TYPE.NEXT,       new int[][] { new int[] {0, -1} }}
    ...
    protected static Dictionary<DUNGEON_DIRECTION, Dictionary<DUNGEON_END_TYPE, int[][]>> closeEnd = new Dictionary<DUNGEON_DIRECTION, Dictionary<DUNGEON_END_TYPE, int[][]>>() {
        { DUNGEON_DIRECTION.NORTH, new Dictionary<DUNGEON_END_TYPE, int[][]>() {
            { DUNGEON_END_TYPE.WALLED,     new int[][] { new int[] {0, -1}, new int[] {1, -1}, new int[] {1, 0}, new int[] {1, 1}, new int[] {0, 1} }},
            { DUNGEON_END_TYPE.CLOSE,      new int[][] { new int[] {0, 0} }},
            { DUNGEON_END_TYPE.RECURSE,    new int[][] { new int[] {-1, 0} }}
        }},
        { DUNGEON_DIRECTION.SOUTH, new Dictionary<DUNGEON_END_TYPE, int[][]>() {
            { DUNGEON_END_TYPE.WALLED,     new int[][] { new int[] {0, -1}, new int[] {-1, -1}, new int[] {-1, 0}, new int[] {-1, 1}, new int[] {0, 1} }},
            { DUNGEON_END_TYPE.CLOSE,      new int[][] { new int[] {0, 0} }},
        ...
        { DUNGEON_DIRECTION.WEST, new Dictionary<DUNGEON_END_TYPE, int[][]>() {
            { DUNGEON_END_TYPE.WALLED,     new int[][] { new int[] {-1, 0}, new int[] {-1, 1}, new int[] {0, 1}, new int[] {1, 1}, new int[] {1, 0} }},
            { DUNGEON_END_TYPE.CLOSE,      new int[][] { new int[] {0, 0} }},
            { DUNGEON_END_TYPE.RECURSE,    new int[][] { new int[] {0, -1} }}
        }},
        { DUNGEON_DIRECTION.EAST, new Dictionary<DUNGEON_END_TYPE, int[][]>() {
            { DUNGEON_END_TYPE.WALLED,     new int[][] { new int[] {-1, 0}, new int[] {-1, -1}, new int[] {0, -1}, new int[] {1, -1}, new int[] {1, 0} }},
            { DUNGEON_END_TYPE.CLOSE,      new int[][] { new int[] {0, 0} }},
    ...
    public static uint TRAPPED =   0x00100000;
    public static uint SECRET =    0x00200000;
    public static uint PORTC =     0x00400000;
    public static uint STAIR_DN =  0x00800000;
    public static uint STAIR_UP =  0x01000000;

    public static uint LABEL = 0xFF000000;

    public static uint OPENSPACE = ROOM | CORRIDOR;
    public static uint DOORSPACE = ARCH | OPEN | CLOSED | LOCKED | TRAPPED | SECRET | PORTC;
    ...
    public int nRows;
    public int nCols;
    public DUNGEON_LAYOUT dungeonLayout;
    public int roomMin;
    public int roomMax;
    public DUNGEON_ROOM_LAYOUT roomLayout;
    public DUNGEON_CORRIDOR_LAYOUT corridorLayout;
    public int removeDeadends;
    public int addStairs;
    ...
    public Dungeon(int seed, int nRows, int nCols, DUNGEON_LAYOUT dungeonLayout, int roomMin, int roomMax, DUNGEON_ROOM_LAYOUT roomLayout, DUNGEON_CORRIDOR_LAYOUT corridorLayout, int removeDeadends, int addStairs) {
        this.seed = seed;
        this.nRows = nRows;
        this.nCols = nCols;
    ...
    private void InitCells() {
        ...
        if(dungeonLayouts.ContainsKey(dungeonLayout)) {
            MaskCells(dungeonLayouts[dungeonLayout]);
        }
        else if(dungeonLayout == DUNGEON_LAYOUT.ROUND) {
            RoundMask();
        }
    }
    ...
    private void EmplaceRooms() {
        if(roomLayout == DUNGEON_ROOM_LAYOUT.PACKED) {
            PackRooms();
        }
        else if(roomLayout == DUNGEON_ROOM_LAYOUT.SCATTERED) {
            ScatterRooms();
        }
    }
    ...
    private void OpenRoom(RoomData room) {
        ...
        for(int i = 0; i < nOpens; ++i) {
            ...
            DUNGEON_DIRECTION openDir = sill.dir;
            ...
            if(!room.doorWasSet) {
                ...
                room.door = new Dictionary<DUNGEON_DIRECTION, DoorData>();
            }
    ...
    private List<SillData> DoorSills(RoomData room) {
        ...
        if(room.north >= 3) {
            for(int c = room.west; c <= room.east; c += 2) {
                SillData sill = CheckSill(room, room.north, c, DUNGEON_DIRECTION.NORTH);
        ...
        if(room.south <= (nRows - 3)) {
            for(int c = room.west; c <= room.east; c += 2) {
                SillData sill = CheckSill(room, room.south, c, DUNGEON_DIRECTION.SOUTH);
        ...
        if(room.west >= 3) {
            for(int r = room.north; r <= room.south; r += 2) {
                SillData sill = CheckSill(room, r, room.west, DUNGEON_DIRECTION.WEST);
        ...
        if(room.east <= (nCols - 3)) {
            for(int r = room.north; r <= room.south; r += 2) {
                SillData sill = CheckSill(room, r, room.east, DUNGEON_DIRECTION.EAST);
    ...
    private SillData CheckSill(RoomData room, int sillR, int sillC, DUNGEON_DIRECTION dir) {
    ...
    private void Tunnel(int i, int j, DUNGEON_DIRECTION lastDir = DUNGEON_DIRECTION.UNKNOWN) {
        DUNGEON_DIRECTION[] dirs = TunnelDirs(lastDir);

        foreach(DUNGEON_DIRECTION dir in dirs) {
    ...
    private DUNGEON_DIRECTION[] TunnelDirs(DUNGEON_DIRECTION lastDir) {
        int p = corridorLayouts[corridorLayout];
        List<DUNGEON_DIRECTION> dirs = Shuffle(new List<DUNGEON_DIRECTION>(dj.Keys));

        if(lastDir != DUNGEON_DIRECTION.UNKNOWN && p > 0 && random.Next(100) < p) {
    ...
    private bool OpenTunnel(int i, int j, DUNGEON_DIRECTION dir) {
        int thisR = (i * 2) + 1;
        int thisC = (j * 2) + 1;
    ...
    private void EmplaceStairs() {
        ...
        for(int i = 0; i < n; ++i) {
            ...
            if(type == 0) {
                ...
                stair.dir = DUNGEON_STAIR_DIRECTION.DOWN;
            }
            else {
                cell[r][c] |= STAIR_UP;
                cell[r][c] |= (Convert.ToUInt32('u') << 24);
                stair.dir = DUNGEON_STAIR_DIRECTION.UP;
            }
    ...
    private List<StairData> StairEnds() {
        ...
        for(int i = 0; i < nI; ++i) {
            ...
            for(int j = 0; j < nJ; ++j) {
                ...
                foreach(DUNGEON_DIRECTION dir in stairEnd.Keys) {
                    if(CheckTunnel(r, c, stairEnd[dir])) {
                        StairData end = new StairData(r, c);

                        int[] n = stairEnd[dir][DUNGEON_END_TYPE.NEXT][0];
    ...
    private bool CheckTunnel(int r, int c, Dictionary<DUNGEON_END_TYPE, int[][]>check) {
        int[][] list;

        if(check.ContainsKey(DUNGEON_END_TYPE.CORRIDOR)) {
            list = check[DUNGEON_END_TYPE.CORRIDOR];
        ...
        if(check.ContainsKey(DUNGEON_END_TYPE.WALLED)) {
            list = check[DUNGEON_END_TYPE.WALLED];
    ...
    private void CollapseTunnels(int p, Dictionary<DUNGEON_DIRECTION, Dictionary<DUNGEON_END_TYPE, int[][]>> xc) {
        if(p == 0) {
            return;
        }
        ...
        for(int i = 0; i < nI; ++i) {
            ...
            for(int j = 0; j < nJ; ++j) {
                ...
                if((all || (random.Next(100)) < p) == false) {
                    continue;
                }
    ...
    private void Collapse(int r, int c, Dictionary<DUNGEON_DIRECTION, Dictionary<DUNGEON_END_TYPE, int[][]>> xc) {
        if((cell[r][c] & OPENSPACE) == NOTHING) {
            return;
        }

        foreach(DUNGEON_DIRECTION dir in xc.Keys) {
            if(CheckTunnel(r, c, xc[dir])) {
                foreach(int[] p in xc[dir][DUNGEON_END_TYPE.CLOSE]) {
                    cell[r + p[0]][c + p[1]] = NOTHING;
                }

                if(xc[dir].ContainsKey(DUNGEON_END_TYPE.OPEN)) {
                    int[] p = xc[dir][DUNGEON_END_TYPE.OPEN][0];
                    cell[r + p[0]][c + p[1]] |= CORRIDOR;
                }
                if(xc[dir].ContainsKey(DUNGEON_END_TYPE.RECURSE)) {
                    int[] p = xc[dir][DUNGEON_END_TYPE.RECURSE][0];
    ...
    private void FixDoors() {
        try {
            ...
            foreach(RoomData room in rooms.Values) {
                List<DUNGEON_DIRECTION> dirs = new List<DUNGEON_DIRECTION>(room.door.Keys);

                foreach(DUNGEON_DIRECTION dir in dirs) {
                    List<DoorData> shiny = new List<DoorData>();

                    foreach(DUNGEON_DIRECTION dirDoor in room.door.Keys) {
                        ...
                        if(fix[doorR][doorC]) {
                            ...
                            if(room.door[dirDoor].outIDWasSet) {
                                ...
                                DUNGEON_DIRECTION outDir = opposite[dir];
                                RoomData outRoom = rooms[outID];

                                if(!outRoom.doorWasSet) {
                                    outRoom.door = new Dictionary<DUNGEON_DIRECTION, DoorData>();
                                }
